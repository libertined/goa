...
?>
  ...
  <h3>Топ 5 наших экскурсий</h3>
	...
	$APPLICATION->IncludeComponent("bitrix:news.list", "top_main", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"DETAIL_URL" => "/excursion/#CODE#/",	// URL страницы детального просмотра (по умолчанию - из настроек инфоблока)
		...
		"FILTER_NAME" => "filterExcursion",	// Фильтр
  ...
  <div class="see marg-t-40">
    <div class="see__icon"><object type="image/svg+xml" data="upload/svg/trip.svg">Your browser does not support SVGs</object></div>
