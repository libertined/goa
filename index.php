...
$APPLICATION->SetPageProperty("keywords_inner", "Твой Гоа, из Гоа в Хампи, из Гоа в Дели, экскурсии в Гоа");
$APPLICATION->SetPageProperty("keywords", "Гоа, Индия, экскурсии, туры по Индии, из Гоа в Дели, из Гоа в Хампи");
$APPLICATION->SetPageProperty("description", "Твой Гоа предлагает разнообразные экскурсии в Гоа и увлекательные туры по Индии. Мы имеем лицензию на туристическую и транспортную деятельность, а все наши водители - лицензию для работы с туристами. Нам доверяют и нас рекомендуют.");
