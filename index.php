  ...
  <div class="right-side__top5-wrap">
    <div class="row row--padd30">
      <div class="row__inner">
        <div class="col-12-5"><a href="" class="right-side__top5"><img src="img/files/img_1.jpg" alt="" /></a></div>
        <div class="col-12-7">
          <a href="" class="right-side__top5"><img src="img/files/img_2.jpg" alt="" /></a>
              ...
              <div class="row__inner">
                ...
                <div class="col-12-7">
                  <div class="row row--padd10">
                    <div class="row__inner">
                      <div class="col-12-4"><a href="" class="right-side__top5"><img src="img/files/img_3.jpg" alt="" /></a></div>
                      <div class="col-12-4"><a href="" class="right-side__top5"><img src="img/files/img_4.jpg" alt="" /></a></div>
                      <div class="col-12-4"><a href="" class="right-side__top5"><img src="img/files/img_5.jpg" alt="" /></a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row__inner">
            <div class="col-12-4">
              <div class="slider-review__item-info">
                <div class="slider-review__item-pic"><object type="image/svg+xml" data="svg/faceless.svg">Your browser does not support SVGs</object></div>
                <div class="slider-review__item-name">Александр Петрович Гущин</div>
                <div class="slider-review__item-date">3/01/2016</div>
              </div>
            </div>
            <div class="col-12-8">
              <div class="slider-review__item-text">Добрый день и с Новым годом! Хотел бы выразить большую благодарность нашим гидам - Ольге (ездили в Мумбаи, 10 декабря) и особенно Елене Беленькой (весь Гоа, Хампи и Бадами, 12-14 декабря)! Замечательные гиды, очень интересные, отзывчивые, умеют работать с людьми (я как руководитель туристического агентства и гид со стажем точно это утверждаю!), знают информацию и просто замечательные люди!! Спасибо за проведенные дни в Индии, и я надеюсь мы еще воспользуемся услугами компании! PS. Большой привет Елене Беленькой!</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="slider-review__item">
        <div class="row row--padd30">
          <div class="row__inner">
            <div class="col-12-4">
              <div class="slider-review__item-info">
                <div class="slider-review__item-pic"><img src="img/files/img_1.jpg" alt="" /></div>
                <div class="slider-review__item-name">Александр Петрович Гущин</div>
                <div class="slider-review__item-date">3/01/2016</div>
              </div>
            </div>
