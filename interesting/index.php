...
$APPLICATION->SetTitle("Интересно об Индии");
?>
    <div class="interesting stick-border">
        ...
        <? if (!isset($_REQUEST["tags"])): ?>
                <? $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "PAGE_LIST" => '/interesting'
                    ),
                    false
                ); ?>
        <?else:?>
            <?$APPLICATION->IncludeComponent("bitrix:search.page", "interesting", Array(
                ...
                "PAGER_TITLE" => "Интересно об Индии",	// Название результатов поиска
        ...
        <aside class="interesting-labels" id="sticker">
            <? $APPLICATION->IncludeComponent("bitrix:search.tags.cloud", "interesting", Array(
                "CACHE_TIME" => "3600",    // Время кеширования (сек.)
                "CACHE_TYPE" => "A",    // Тип кеширования
                "CHECK_DATES" => "N",    // Искать только в активных по дате документах
