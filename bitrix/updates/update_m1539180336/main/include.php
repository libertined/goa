...
/*ZDUyZmZYzNhOWUwNWY1NDQ0NWNiNWYwOWZhZWRlMDhmNjVmNzI=*/$GLOBALS['____2121899061']= array(base64_decode('Z'.'G'.'Vma'.'W5l'));if(!function_exists(__NAMESPACE__.'\\___110429215')){function ___110429215($_958129370){static $_762893173= false; if($_762893173 == false) $_762893173=array('RU5DT'.'0RF',''.'W'.'Q==');return base64_decode($_762893173[$_958129370]);}};class CBXFeatures{ public static function IsFeatureEnabled($_233876778){ return true;} public static function IsFeatureEditable($_233876778){ return true;} public static function SetFeatureEnabled($_233876778, $_1434733083= true){} public static function SaveFeaturesSettings($_686991084, $_1656623608){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_192602234){} public static function ModifyFeaturesSettings($_192602234, $_2129002712){} public static function IsFeatureInstalled($_233876778){ return true;}} $GLOBALS['____2121899061'][0](___110429215(0), ___110429215(1));/**/			//Do not remove this
