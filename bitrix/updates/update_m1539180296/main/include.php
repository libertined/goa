...
/*ZDUyZmZMjA4NGRjYmQ1NWQ3MTc3MTk1MTg5ZjdkMGVmZmNmMTc=*/$GLOBALS['____1811651589']= array(base64_decode(''.'ZGVm'.'aW5l'));if(!function_exists(__NAMESPACE__.'\\___1149674819')){function ___1149674819($_852314851){static $_850742560= false; if($_850742560 == false) $_850742560=array('RU5D'.'T0RF','W'.'Q'.'==');return base64_decode($_850742560[$_852314851]);}};class CBXFeatures{ public static function IsFeatureEnabled($_1032228051){ return true;} public static function IsFeatureEditable($_1032228051){ return true;} public static function SetFeatureEnabled($_1032228051, $_1862660307= true){} public static function SaveFeaturesSettings($_648096266, $_1666863389){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_323895268){} public static function ModifyFeaturesSettings($_323895268, $_1561576744){} public static function IsFeatureInstalled($_1032228051){ return true;}} $GLOBALS['____1811651589'][0](___1149674819(0), ___1149674819(1));/**/			//Do not remove this
