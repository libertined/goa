...
{
	if ($_REQUEST["apply_filter"] == "Y" && (array_key_exists(
		"clear_nav", $_REQUEST) && $_REQUEST["clear_nav"] == "Y"))
	{
		if (intval($arFilter["SECTION_ID"]))
		{
			$find_section_section = intval($arFilter["SECTION_ID"]);
		}
	}
...
$lAdmin->setContextSettings(array("pagePath" => $selfFolderUrl.$listScriptName));
