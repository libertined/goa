...
<?foreach($arResult["SEARCH"] as $arItem):?>
    <article class="advices-item" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
        <a href="<?=$arItem["URL"]?>" class="advices-item__detailed-link">
            <div class="advices-item__header"><?=$arItem["TITLE"]?></div>
            <p class="advices-item__short-text"><?=$arItem["DESCRIPTION"];?></p>
        </a>
