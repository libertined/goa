...
$module_id = 'goa.domain';

$arMeetingsOptions = array(
	array("participant_cabinet", GetMessage("PARTICIPANT_CABINET"), "N", array("text", 5)),
	array("guest_cabinet", GetMessage("GUEST_CABINET"), "N", array("text", 5)),
);
$aTabs = [
    array(
        "DIV" => "edit1",
...
$arAllOptions = $arMeetingsOptions;
...
if ($STAS_RIGHT >= "R") {
    ...
    <?$tabControl->BeginNextTab();?>
        <!-- Настройки бонусов -->
        <tr class="heading"><td colSpan="2"><?= GetMessage('MEETING_SETTINGS')?></td></tr>
            <?
            foreach($arMeetingsOptions as $arOption):
